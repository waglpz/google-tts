...
/**
 * Ein Strategy-Objekt wird erstellt, um die Konfiguration für die Text-zu-Sprache-Konvertierung
 ...
 */
$strategy = (new SynthesizeSpeechStrategyFactory(
    LanguageCode::DE_DE,
...
Ich bin hier um zu sagen: "Das ist ein guter Test!".
TEXT;
